...
// Project paths
var project     = 'rcms'                 // The directory name for your theme; change this at the very least!
...
module.exports = {
  ...
  , proxy: 'localhost/rcms' // We need to use a proxy instead of the built-in server because WordPress has to do some server-side rendering for the theme to work
  , watchOptions: {
